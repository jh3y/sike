...
if (program.interval && (typeof(program.interval) === "string" || typeof(program.interval) === "number")) {
...
} else if (program.interval) {
	console.error("sike: you need to set an interval");
}
if (program.duration) {
